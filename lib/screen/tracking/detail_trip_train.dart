          ...
          body: LayoutBuilder(
            builder: (BuildContext context, BoxConstraints constraints) {
              if (constraints.maxWidth <= 600) {
                return DetailTripPageTrainState.initialize();
...
class DetailTripPageTrainState extends StatelessWidget {
  DetailTripPageTrainState({super.key});
  late User? user;
  // late String userName;
  // late String userFoto;

  DetailTripPageTrainState.initialize({super.key}) {
    initializeUser();
  }
