...
### because when debugging requires SHA-1 and SHA-256 on each computer which is then placed in our application's firebase, it's best to just download the ready-made application if you want to check
